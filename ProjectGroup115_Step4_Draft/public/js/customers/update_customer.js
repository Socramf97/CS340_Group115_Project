...
updatecustomerForm.addEventListener("submit", function (e) {
    ...
    let inputCustomerID = document.getElementById("custSelect");
    let inputCustomerType = document.getElementById("input-custtype-update");
...
function updateRow(data, customerID){
    ...
    for (let i = 0, row; row = table.rows[i]; i++) {
       ...
       if (table.rows[i].getAttribute("data-value") == customerID) {
            ...
            td.innerHTML = parsedData.customerType; 

            console.log(parsedData.customerType)
       }
    }
}